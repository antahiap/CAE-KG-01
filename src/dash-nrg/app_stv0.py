...
def set_plots(c_grp, ords, ns, nPid, sims, pids):
    ...
    fig3 = px.scatter(
        df1, x="tn", y="IE", color=c_grp, custom_data=["pic"],
        hover_name="PID",
        hover_data=h_data)
    ...
    fig4 = px.scatter(
        df1, x="ti", y="tn", color=c_grp, custom_data=["pic"],
        hover_name="PID",
        hover_data=h_data)
...
ns = 100
nPid = 8
sims = '.*stv0_.*116_fp3.*,.*stv0_.*004_fp3.*'
sims = '.*stv0_.*004_fp3.*'
pids = ''
# pids = '10020100, 10021360, 55131230, 18620040, 10020210'
    ...
    html.Div(className='row', children=[
        ...
        html.Div(
            ...
            children=html.Div([
                ...
                dcc.Graph(id='embd-2ds-tn', figure=fig3)])
                ),
        html.Div(
